...
func TestTransformedRowsCarryTheNewSchemasShape(t *testing.T) {
	...
	require.NotContains(t, analyzers[0], "multiplier_confirmed", "not a column: load reads manual_multipliers.csv (R429)")
	require.Equal(t, "M-1", analyzers[0]["counterparty_no"], "R429")
