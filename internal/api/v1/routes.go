...
func Table() []Route {
	return slices.Concat(systemRoutes(), authRoutes(), tenancyRoutes(), assetRoutes(), analysisRoutes(), billingRoutes(),
		tariffRoutes(), icmalRoutes(), solarRoutes(), calendarRoutes(), jobRoutes(), alarmRoutes(), opsRoutes(), reportRoutes(), plantRoutes(), renewableRoutes(), panelRoutes(), carbonRoutes(), iso50001Routes())
}
